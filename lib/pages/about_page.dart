...
OldBirds 是一个微信公众号。早期没怎么去管理，荒废了挺久。后面代码写多了，文章看多了，觉得文字上的总结不可或缺。所以在 2020 年开始正式开启公众号写作之旅。
...
这几年，前端的 React、Vue、小程序都倒腾了一段时间，当然还有 Python。对技术的好奇心至今未减。
自己也不是聪明人，在学这方面，走了也走了很多曲线，浪费了挺多时间的。所以想在自己采坑的地方记录下来，形成专题，分享给那些需要的人————这也是 OldBirds 一直做的事情。
